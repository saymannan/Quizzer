...
module.exports.get_quiz_detail_generic = function( redis, Qid, lower_limit, upper_limit, callback){
...
module.exports.set_log_detail = function( redis, user, Qid, section_count, question_count, duration, trials,callback ){
	redis.rpush( log_schema.set_name + user + ":" + Qid, section_count, question_count, duration, trials, function (err, stat){
		if( !err ){
			callback(null, stat);
		}else{
